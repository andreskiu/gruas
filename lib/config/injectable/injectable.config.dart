...
import '../../application/auth/login_page_state.dart' as _i35;
import '../../application/grua/grua_service_state.dart' as _i10;
import '../../domain/auth/services/auth_service.dart' as _i26;
import '../../domain/auth/use_cases/get_user_logged_in.dart' as _i31;
import '../../domain/auth/use_cases/get_user_remembered.dart' as _i32;
import '../../domain/auth/use_cases/login.dart' as _i33;
import '../../domain/auth/use_cases/logout.dart' as _i34;
import '../../domain/grua/services/grua_service.dart' as _i21;
import '../../domain/grua/use_cases/get_evidence_types.dart' as _i28;
import '../../domain/grua/use_cases/get_service_routes.dart' as _i29;
import '../../domain/grua/use_cases/get_services.dart' as _i30;
import '../../domain/grua/use_cases/save_evidence.dart' as _i24;
import '../../domain/grua/use_cases/save_service.dart' as _i25;
...
import '../../infrastructure/grua/repositories/grua_server_repository.dart'
    as _i17;
import '../../infrastructure/grua/services/grua_service.dart' as _i22;
...
import 'injectable.dart' as _i23;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i14.IFirebaseService>(() => _i15.GruaDemoRepositoryImpl(),
      registerFor: {_demo});
  gh.lazySingleton<_i14.IFirebaseService>(() => _i16.GruaDemoRepositoryImpl(),
      registerFor: {_dev, _qa, _prod});
  gh.lazySingleton<_i14.IServerService>(() => _i17.GruaServerRepository(),
      registerFor: {_dev, _qa, _prod});
  ...
  gh.lazySingleton<_i21.IGruaService>(() => _i22.GruaServiceImpl(
      firebase: get<_i14.IFirebaseService>(),
      server: get<_i14.IServerService>()));
  gh.factory<_i4.InterceptorsWrapper>(
      () => _i23.AppInterceptorsWrapper(
          authRepo: get<_i19.IAuthStorageRepository>()),
      registerFor: {_dev, _qa, _prod});
  gh.lazySingleton<_i24.SaveEvidenceUseCase>(
      () => _i24.SaveEvidenceUseCase(get<_i21.IGruaService>()));
  gh.lazySingleton<_i25.SaveServicesUseCase>(
      () => _i25.SaveServicesUseCase(get<_i21.IGruaService>()));
  ...
  gh.lazySingleton<_i28.GetEvidenceTypesUseCase>(
      () => _i28.GetEvidenceTypesUseCase(get<_i21.IGruaService>()));
  gh.lazySingleton<_i29.GetServiceRouteUseCase>(
      () => _i29.GetServiceRouteUseCase(get<_i21.IGruaService>()));
  gh.lazySingleton<_i30.GetServicesUseCase>(
      () => _i30.GetServicesUseCase(get<_i21.IGruaService>()));
  gh.lazySingleton<_i31.GetUserLoggedInUseCase>(
      () => _i31.GetUserLoggedInUseCase(get<_i26.AuthService>()));
  gh.lazySingleton<_i32.GetUserRememberedUseCase>(
      () => _i32.GetUserRememberedUseCase(get<_i26.AuthService>()));
  gh.lazySingleton<_i33.LoginUseCase>(
      () => _i33.LoginUseCase(get<_i26.AuthService>()));
  gh.lazySingleton<_i34.LogoutUseCase>(
      () => _i34.LogoutUseCase(get<_i26.AuthService>()));
  gh.factory<_i35.LoginPageState>(() => _i35.LoginPageState(
      loginUseCase: get<_i33.LoginUseCase>(),
      getUserRememberedUseCase: get<_i32.GetUserRememberedUseCase>()));
  return get;
}
